...
if (region != 'us-east-1') {
    Infra.job(this, job_folder, "us-east-1-certificate", env_disable_pipes, codecommit, default_branch, jenkins_scripts, stage, tenant, 'us-east-1', profile, python_exe, "create_us_east_1_certificate.py")
}
